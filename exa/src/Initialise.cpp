...
void Initialise::random(std::vector<Particle>& particles, CellList& cells, Box& box, MersenneTwister& rng, bool isSpherocylinder)
{
	...
	particles[i].charge = rng.real(-1.0,1.0);	
...
// void Initialise::random(std::vector<Atom>& atoms, CellList& cells, Box& box, MersenneTwister& rng, bool isSpherocylinder)
// {
//     for (unsigned i=0;i<atoms.size();i++)
//     {
//       atoms[i].charge = rng.real(-1.0,1.0);
//     }
//     random(atoms,cells,box,rng,isSpherocylinder);
// }
